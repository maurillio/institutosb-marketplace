-- ============================================
-- INSERIR OS 7 CURSOS FALTANTES (VERSÃO SIMPLIFICADA)
-- Execute no console Neon
-- ============================================

-- Curso 4 - Skincare
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-004', 'ONLINE', 'BEGINNER', 547.00, '/images/courses/skincare.jpg', 720, TRUE, 'PUBLISHED',
NOW(), 4.6, 0, 0, NOW(), NOW())
...
'instrutor-005', 'ONLINE', 'INTERMEDIATE', 447.00, '/images/courses/unhas.jpg', 600, TRUE, 'PUBLISHED',
NOW(), 4.7, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Curso 6 - Alongamento de Cílios
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, "compareAtPrice", thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-006', 'HYBRID', 'BEGINNER', 697.00, 997.00, '/images/courses/cilios.jpg', 480, TRUE, 'PUBLISHED',
NOW(), 4.8, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Curso 7 - Maquiagem Editorial
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-001', 'IN_PERSON', 'ADVANCED', 1497.00, '/images/courses/maquiagem.jpg', 960, TRUE, 'PUBLISHED',
NOW(), 4.9, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Curso 8 - Corte e Escova
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-002', 'IN_PERSON', 'ALL_LEVELS', 1897.00, '/images/courses/maquiagem.jpg', 2400, TRUE, 'PUBLISHED',
NOW(), 4.7, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Curso 9 - Marketing Digital
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, "compareAtPrice", thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-003', 'ONLINE', 'BEGINNER', 297.00, 497.00, '/images/courses/marketing.jpg', 480, TRUE, 'PUBLISHED',
NOW(), 4.5, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Curso 10 - Gestão de Salão
INSERT INTO "courses" (id, title, slug, description, "shortDescription", "instructorId", type, level, price, "compareAtPrice", thumbnail, duration, certificate, status, "publishedAt", rating, "totalReviews", "totalEnrollments", "createdAt", "updatedAt")
VALUES
...
'instrutor-004', 'ONLINE', 'ALL_LEVELS', 697.00, 997.00, '/images/courses/empreendedorismo.jpg', 1200, TRUE, 'PUBLISHED',
NOW(), 4.8, 0, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
